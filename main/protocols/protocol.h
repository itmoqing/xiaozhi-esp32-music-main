...
public:
    ...
    virtual void SendMcpMessage(const std::string& message);
      ...
      // ==================== ⬇️ 在这里添加新函数 ⬇️ ====================
    /**
     * @brief 向服务器发送一个通用的文本消息。
     * @param text 要发送的文本内容。
     * @param type 消息类型 (例如 "stt", "command")，用于服务器区分处理。
     * @param source 消息来源 (例如 "user", "alarm")，用于服务器追溯来源。
     * @return true 如果成功发送, 否则 false。
     */
    virtual bool SendTextToServer(const std::string& text, const std::string& type = "stt", const std::string& source = "user");
    // ==================== ⬆️ 新增结束 ⬆️ ====================
